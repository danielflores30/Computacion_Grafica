...
int main() {
 ...
 //     
	...
	projection = glm::perspective(45.0f, (GLfloat)screenWidth / (GLfloat)screenHeight, 0.1f, 100.0f);//FOV, Radio de aspecto,znear,zfar (Igual se conf con la lina 221 "view")
	//projection = glm::ortho(0.0f, (GLfloat)screenWidth, 0.0f, (GLfloat)screenHeight/*alto de la pantalla */ , 0.1f, 1000.0f);//Izq,Der,Fondo,Alto,Cercania,Lejania
	while (!glfwWindowShouldClose(window))
	{
	    ...
	    view = glm::translate(view, glm::vec3(0.0f,0.0f,-15.0f)); //(Se relaciona con linea 203)
