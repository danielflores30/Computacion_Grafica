...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLfloat currentFrame = glfwGetTime(); //Calculamos el frame actual 
		deltaTime = currentFrame - lastFrame; //Cada ciclo se calcula el tiempo que ha transcurrido y nos da la velocidad de las animaciones 
		...
		// Point light 1
	    glm::vec3 lightColor;
		//Proceso por el cual pasa la luz 
